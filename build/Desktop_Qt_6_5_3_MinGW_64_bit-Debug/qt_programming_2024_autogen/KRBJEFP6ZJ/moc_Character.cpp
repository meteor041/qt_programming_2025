...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCharacterENDCLASS_t qt_meta_stringdata_CLASSCharacterENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 4),  // "died"
        QT_MOC_LITERAL(15, 0),  // ""
        QT_MOC_LITERAL(16, 10),  // "Character*"
        QT_MOC_LITERAL(27, 9)   // "character"
    },
    "Character",
    "died",
    "",
...
Q_CONSTINIT const QMetaObject Character::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSCharacterENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<Character *, std::false_type>
    >,
    nullptr
} };
...
void Character::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->died((*reinterpret_cast< std::add_pointer_t<Character*>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Character::died; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
